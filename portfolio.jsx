...
import { ChevronDown, Github, Linkedin, Mail, Shield, Lock, Terminal, Zap, Code, Brain, Cpu, Eye } from 'lucide-react';
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <motion.div
          ...
          className="w-8 h-8 rounded border border-emerald-500 flex items-center justify-center cursor-pointer"
        >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-sm md:text-base text-rose-300/60 font-mono">
            Final-year BS Computer Science @ FAST NUCES · Graduating June 2026
          </p>
        </motion.div>
...
const CertificationsSection = () => {
  const certs = [
    ...
    { name: 'Google Cybersecurity Certificate', issuer: 'Google / Coursera', date: 'In Progress', icon: Shield },
...
const ContactSection = () => {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText('sabahatjahangir832@gmail.com');
    setCopied(true);
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          >
            ...
            <p className="text-emerald-300/60 text-sm font-mono break-all">sabahatjahangir832@gmail.com</p>
            <AnimatePresence>
              {copied && (
                <motion.p
                  initial={{ opacity: 0 }}
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <motion.a
                href="mailto:sabahatjahangir832@gmail.com"
                whileHover={{ scale: 1.2, color: '#34d399' }}
                className="text-rose-300/60 hover:text-emerald-400 transition"
              >
        ...
        <div className="border-t border-emerald-500/10 pt-8">
          ...
          >
            ...
            <p>Building Secure & Intelligent Systems • Powered by Cybersecurity Excellence</p>
          </motion.div>
        </div>
      </div>
    </motion.footer>
